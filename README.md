...
| 평가 방식 | 80문항 평가셋(초기) → 20문항 평가셋(`eval_batch_45_rank_11-30`, 현재) + LLM-as-a-Judge 기반 다면 평가 |
...
|---|---|---|
| 스케일 | 대상 문서 처리 | 101건 |
| 스케일 | 평가셋 규모 | 20문항 (`eval_batch_45_rank_11-30`) |
| 검색 품질 | Hit Rate@5 | 1.000 |
| 검색 품질 | MRR | 1.000 |
| 검색 품질 | nDCG@5 | 1.000 |
| 생성 품질 | Faithfulness | 1.000 |
| 생성 품질 | Answer Relevance | 0.800 |
| 생성 품질 | Context Precision | 0.933 |
| 생성 품질 | Context Recall | 0.900 |
| 운영 | Latency (avg) | 33.1초 (`Top-K=5`) |
| 운영 | Latency (P95) | 58.3초 (`Top-K=5`) |
| 운영 | Cost per Query | `$0.0146` (`Top-K=5`, gpt-5-mini) |
| 운영 | Total Cost | `$0.2926` (20문항 run) |
| 인터페이스 | 기본 사용자 인터페이스 | Next.js + FastAPI |
| 인터페이스 | 팀 디버깅 인터페이스 | Streamlit 3탭 UI |
...
<p align="center">
  <img src="./reports/figures/nextjs-user-demo.gif" alt="Next.js user demo" width="92%" />
</p>
...
<p align="center">
  <img src="./reports/figures/streamlit-demo.gif" alt="Streamlit evaluation demo" width="88%" />
</p>
